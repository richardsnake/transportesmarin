...
?>
    ...
    <tr>
      <td height="38" colspan="9"><div align="center">
        <p><strong>MERCADERIA RECEPCIONADA</strong></p>
        <hr/>
        <table width="1245" border="0">
          <tr align="center">
            <td width="86" bgcolor="#00CC66"><div align="center"><strong>C REM </strong></div></td>
        <td width="237" bgcolor="#00CC66"><div align="center"><strong>DESCRIPCION</strong></div></td>
        <!--<td width="68" bgcolor="#00CC66"><div align="center"><strong>F.PAGO</strong> </div></td> -->
        <td width="96" bgcolor="#00CC66"><div align="center"><strong>EST. PAGO </strong></div></td>
        <td width="59" bgcolor="#00CC66"><div align="center"><strong>TOTAL</strong></div></td>
        <td width="53" bgcolor="#00CC66"><div align="center"><strong>VIAJE</strong></div></td>
        <td width="97" bgcolor="#00CC66"><div align="center"><strong>VEHICULO</strong></div></td>
        <td width="68" bgcolor="#00CC66"><div align="center"><strong>FECHA</strong></div></td>
        <td width="82" bgcolor="#00CC66"><div align="center"><strong>ESTADO</strong></div></td>
        <!--<td width="91" bgcolor="#00CC66"><div align="center"><strong>N&ordm; COMP. </strong></div></td>-->
        <td width="98" bgcolor="#00CC66"><div align="center"><strong>N&ordm; GUIA  </strong></div></td> 
        <td width="327" bgcolor="#00CC66"><div align="center"><strong>REMITENTE</strong></div></td>
          </tr>
           <?php
	  		$sql="SELECT A.Descripcion, A.Remitente, A.Destinatario, A.EstadoPago, A.Viaje_CodViaje, A.Comprobante_Codigo, V.estadoViaje, V.Vehiculo_placa, C.Numero, C.nGuiaRemision, C.total, C.Fecha, CL.RUC, CL.DNI FROM (((articulo AS A INNER JOIN viaje AS V ON A.Viaje_CodViaje=V.CodViaje)INNER JOIN comprobante AS C ON A.Comprobante_Codigo=C.codigo) INNER JOIN cliente AS CL ON A.Cliente_CodigoCliente=CL.CodigoCliente) WHERE A.Destinatario LIKE '%$cliente%' AND A.activo=1 ORDER BY A.Comprobante_Codigo DESC; ";
			$color="#ffffff";
			$result=$bd->crearConsulta($sql);
			if(mysql_num_rows($result)!=0)
			{
