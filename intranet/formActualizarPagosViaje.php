...
<script language="javascript" type="text/javascript">
	...
	function buscar()
	{
		...
		_valores = "op=buscarPagos&clave="+codigo;
      ...
      <tr>
		...
		<form id="form1" name="form1" method="post" action="admin.php">
          <table width="369" border="0" align="center">
            <tr>
              <th height="58" colspan="3" scope="col">ACTUALIZAR PAGO DE VIAJE </th>
              </tr>
            <tr>
              <td width="115" height="34"><em><strong>Codigo:</strong></em></td>
              <td width="168">
                <input name="textCodigo" type="text" id="textCodigo" maxlength="8" />
                </td>
              <td width="64">&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="2"><label>
                <div align="center">
                  ...
                  <label>
                  <input name="op" type="hidden" id="op" value="actualizarPagoViaje" />
                  </label>
                </div>
              </label></td>
              </tr>
