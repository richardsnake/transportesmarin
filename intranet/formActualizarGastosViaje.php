      ...
      <tr>
		...
		<form id="form1" name="form1" method="post" action="admin.php">
          <table width="369" border="0" align="center">
            <tr>
              <th height="58" colspan="3" scope="col">ACTUALIZAR GASTOS DE VIAJE </th>
              </tr>
            <tr>
              <td width="128" height="34"><em><strong>Codigo:</strong></em></td>
              <td width="161">
            ...
            <tr>
              ...
              <td colspan="2"><label>
                <div align="center">
                  ...
                  <label>
                  <input name="op" type="hidden" id="op" value="actualizarGastosViaje" />
                  </label>
                </div>
              </label></td>
              </tr>
