...
<title>:: Transportes Marin Hermanos - RepCiudadesRuta ::</title>
<style type="text/css">
<!--
      ...
      <tr>
        <td height="124"><div align="center">
          <table width="712" border="1">
            <tr>
              <td colspan="7"><div align="center"><strong>REPORTE CIUDADES RUTA </strong></div></td>
              </tr>
            <tr>
              <td width="447"><div align="center" class="Estilo1"> Ruta</div></td>
              <td width="255"><div align="center" class="Estilo1"> Ciudad</div></td>
            </tr>
			  	<?php
					require("../../conexion/config.php");
					require("../../conexion/baseDatos.php");
					$sql="SELECT R.Nombre, C.Distrito, CR.activo, CR.usuario from ((ciudadesruta AS CR  INNER JOIN ruta AS R ON CR.Ruta_CodigoRuta=R.CodigoRuta) INNER JOIN ciudad AS C ON CR.Ciudad_Clave=C.Clave) ORDER BY R.Nombre;";
					...
					{
						//echo"<table><tr>";
						echo"<tr><td><div align=\"center\">".$registro->Nombre."</div></td>";
						echo"<td><div align=\"center\">".$registro->Distrito."</div></td></tr>";
						//echo"</tr></table>";
					}
					//echo"</table>";
					$bdx->cerrarConexion();			 
