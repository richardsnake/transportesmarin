      ...
      <tr>
        <td height="135"><div align="center">
			<?php
				...
				{
					$band=0;
					echo"<tr> <div align=\"center\"> No existe Trabajador ... </div></tr></td>";
					}
				
			?>
          <table width="854" border="0">
            <tr>
              <td height="32" colspan="7"><div align="center"><strong>GASTOS DE PERSONAL: </strong></div></td>
              </tr>
            <tr>
              <td width="204"><div align="right"><strong>Nombres</strong></div></td>
              <td width="182"><?php echo $reg->Nombre?></td>
              ...
              <td height="47" colspan="7"><div align="center">
                <table width="798" border="1">
                  <tr>
                    ...
                    <td width="175" bgcolor="#66CCFF"><div align="center"><strong>MOTIVO</strong></div></td>
                  </tr>
				  <?php
				  	$sql="SELECT codigo, monto, fecha, motivo FROM descuentopersonal WHERE Trabajador_DNI='$dni' AND activo=1;";
					$result=$bdx->crearConsulta($sql);
					if(mysql_num_rows($result)!=0)
					{
