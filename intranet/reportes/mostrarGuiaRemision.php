  ...
  <table width="1105" height="584" border="0" align="left">
    <tr>
      <td width="1099" height="87"><?php
	  		//$codComp=7;
			$sql="SELECT C.codigo, C.Fecha, C.direccionOrigen, C.direccionDestino, C.total, C.docCli, A.Remitente, A.Destinatario, CL.DNI, CL.RUC, CL.TipoCliente FROM (comprobante AS C INNER JOIN articulo AS A ON A.Comprobante_Codigo=C.codigo) INNER JOIN cliente AS CL  ON C.Cliente_CodigoCliente=CL.CodigoCliente WHERE C.nGuiaRemision='$guiaRem';";
      ...
      <td height="139" align="left" valign="top"><div align="center">
        <table width="1131" border="0" align="left">
          <tr align="left">
            ...
            <td width="1009" align="center" valign="top">&nbsp;</td>
            <td width="51">&nbsp;</td>
          </tr>
		  <?php
				...
				{	
					while($reg4=mysql_fetch_object($result4))
					{
						...
						print("<td><div align=\"Center\" class=\"Estilo21\"><strong>".$reg4->Descripcion."  -  ".$docCli."</strong></div></td>");
        ...
        <table width="1113" border="0" align="left">
          ...
          <tr>
            ...
            <td colspan="2"><div align="right" class="Estilo4"><strong>
              <?php $total = $total/1.19; echo number_format($total, 2, '.', ''); ?>
            </strong></div></td>
          </tr>
          <tr>
            <td colspan="9">&nbsp;</td>
          ...
          <tr>
            <td colspan="9"><div align="center">
              <form action="../administrador.php" method="get" name="form1" id="form1">
