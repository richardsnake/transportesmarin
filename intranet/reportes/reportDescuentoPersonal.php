...
<title>:: Transportes Marin Hermanos - repDescuentoPersonal ::</title>
<style type="text/css">
<!--
      ...
      <tr>
        <td height="124"><div align="center">
          <table width="712" border="1">
            <tr>
              <td height="26" colspan="7"><div align="center" class="Estilo3">REPORTE DE PAGOS DE PERSONAL </div></td>
              </tr>
            <tr>
              <td height="26"><div align="center" class="Estilo2">Codigo</div></td>
              <td><div align="center" class="Estilo2">DNI</div></td>	
              <td><div align="center" class="Estilo2">Nombre</div></td>
              <td><div align="center" class="Estilo2">Fecha</div></td>
			  <td><div align="center" class="Estilo2">Motivo</div></td>
			  <td><div align="center" class="Estilo2">Monto</div></td>
            </tr>
			  	<?php
					require("../../conexion/config.php");
					require("../../conexion/baseDatos.php");
					$sql="SELECT DP.codigo, DP.Trabajador_DNI, DP.fecha, DP.motivo, DP.monto, T.Nombre, T.ApellidoPaterno FROM descuentopersonal  AS DP INNER JOIN trabajador AS T ON DP.Trabajador_DNI=T.DNI order by DP.codigo desc;";
