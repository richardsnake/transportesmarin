...
<title>:: Transportes Marin Hermanos - RepRutas ::</title>
<style type="text/css">
<!--
      ...
      <tr>
        <td height="124"><div align="center">
          <table width="712" border="1">
            <tr>
              <td height="35" colspan="7"><div align="center"><strong>REPORTE DE RUTAS</strong></div></td>
              </tr>
            <tr>
              <td height="26"><div align="center" class="Estilo1 Estilo1">Codigo</div></td>
              <td><div align="center" class="Estilo1">C. Origen</div></td>	
              <td><div align="center" class="Estilo1">C. Destino</div></td>
              <td><div align="center" class="Estilo1">Nombre</div></td>
			  	...
			  	<?php
					...
					{
						//echo"<table><tr>";
						echo"<tr><td><div align=\"center\">".$registro->CodigoRuta."</div></td>";
						echo"<td><div align=\"center\">".$registro->CiudadOrigen."</div></td>";
						echo"<td><div align=\"center\">".$registro->CiudadDestino."</div></td>";
